...
const AppWindow = ({ app, icon, onClose, children }) => (
  <div className="absolute inset-0  max-w-6xl mx-auto z-40 flex flex-col max-h-screen mb-20  animate-fade-in border-1 rounded-lg  border-zinc-800">
